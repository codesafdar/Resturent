...
export const ENDPOINTS = {
  ...
  GET_RECOMMENDED_BEVERAGES: `${API_PRODUCT_BASE_URL}get_recommended_beverages?restaurant_id`,
  GET_RECOMMENDED_SIDE: `${API_PRODUCT_BASE_URL}get_recommended_sides?restaurant_id`,
